...
func FlyURL() string {
	return "https://putri-final-kanbanApp-1.fly.dev" // (example URL)to run the website with URL its can get after deploy to Netlify
}

func main() {
	//We can delete it when we will deploy the application
	os.Setenv("DATABASE_URL", "postgres://postgres:132435@localhost:5432/kanbanAppPutri")
